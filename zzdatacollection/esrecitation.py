...
result = model.transcribe(latest_recording, language="en", task = "translate", fp16=False)
...
with open(transcription_filepath, "w", encoding="utf-8") as f:
    f.write(f"original (spanish): {result['text']}\n")
    f.write(f"translation (english): {result['text']}\n")
